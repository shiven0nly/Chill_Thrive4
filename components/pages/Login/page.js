        ...
        <div className="mx-auto max-w-md w-full">
          <div className="relative bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200 shadow-xl p-8">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full h-12 mb-6 border-slate-300 hover:bg-slate-50 cursor-pointer"
            >
              {loading ? (
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-4 text-slate-500">Or log in with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-6">
              ...
              <div className="flex justify-center items-center">
                <Button
                  ...
                  size="lg"
                  disabled={loading}
                  className="cursor-pointer transition-all bg-blue-500 text-white py-2 rounded-lg border-blue-600 w-[200px] border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px] active:border-b-[2px] active:brightness-90 active:translate-y-[2px]"
                >
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-slate-600">
                ...
                <button
                  ...
                  className="font-semibold text-cyan-700 hover:text-cyan-800 underline cursor-pointer"
                >
                  Create an account
                </button>
              </p>
